...
const { addOrderItems, getOrders, getMyOrders, getOrderById, updateOrderToPaid, updateOrderToDelivered, ordersInfo } = require('../controllers/orderController')
...
router.route('/info').get(protected, admin, ordersInfo)
