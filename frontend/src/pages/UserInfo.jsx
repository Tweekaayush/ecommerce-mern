      ...
      <div className="container">
        ...
        <div className="account-content">
          ...
          <div className="account-info">
            ...
            <p className="body-text-3">{isAdmin&&isAdmin?'Admin':'User'}</p>
          </div>
          {!isAdmin && <button className="button-1" style={{marginTop: '16px', alignSelf: 'flex-start'}} onClick={(e)=>[e.stopPropagation(), dispatch(updateUser({_id: id}))]}>Make Admin</button>}
        </div>
